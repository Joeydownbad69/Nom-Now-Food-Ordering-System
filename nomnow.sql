...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2025 at 10:10 AM
...
INSERT INTO `menu_items` (`item_id`, `restaurant_id`, `name`, `description`, `price`, `image_url`) VALUES
(1, 1, 'dummy item', 'juicy cheeseburger', 99.00, NULL);
...
INSERT INTO `restaurants` (`restaurant_id`, `name`, `address`, `contact_info`) VALUES
(1, 'Dummy Restaurant', '123 Restaurant St.', '09999999999');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`driver_id`) REFERENCES `delivery_drivers` (`driver_id`);
